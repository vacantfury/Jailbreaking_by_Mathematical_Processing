...
**Task Name:** `rephrase_conditional_0_4`  
**Generated:** 2025-10-20 22:10:37  
**Experiment Directory:** `/Users/haoyu/Files/US study life and job/study and life/NeU/courses/Fall 2025/CS 8674/repos/Jailbreaking_by_Mathematical_Processing/src/data/experiment_data/20251020_220601_40950831_rephrase_conditional_0_4`
...
| **Prompt Selection** | ID range: 0 to 4 (inclusive) |
...
| **Processing Model** | `('gpt-3.5-turbo', <Provider.OPENAI: 'openai'>)` | Transforms prompts (if LLM-based strategy) |
...
1. `ProcessorType.LLM_REPHRASE`
2. `ProcessorType.NON_LLM_CONDITIONAL_PROBABILITY`
