...
**Task Name:** `task1_markov_gemini_2.5_flash_lite`  
**Generated:** 2025-11-10 06:49:28  
**Experiment Directory:** `/Users/haoyu/Files/US study life and job/study and life/NeU/courses/Fall 2025/CS 8674/repos/Jailbreaking_by_Mathematical_Processing/src/data/experiment_data/20251110_062657_18549457_task1_markov_gemini_2.5_flash_lite`
...
| **Processing Model (default)** | `('meta-llama/Meta-Llama-3-8B-Instruct', <Provider.TRANSFORMERS: 'transformers'>)` | Default model for processors |
...
**Strategy:** `ProcessorType.LLM_MARKOV_CHAIN` (using `('meta-llama/Meta-Llama-3-8B-Instruct', <Provider.TRANSFORMERS: 'transformers'>)`)
